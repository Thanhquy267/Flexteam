package com.example.flexteam.local
...
object PreferenceUtils {
        ...
        if (contextWeakReference.get() != null) {
            ...
            try {
                if (defaultValue is String) {
                    ...
                    return java.lang.Double.longBitsToDouble(sharedPrefs.getLong(key, java.lang.Double.doubleToLongBits(defaultValue)))
                }
            } catch (e: Exception) {
    ...
    const val LATITUTE_ALERT_KEY = "LATITUTE_ALERT_KEY"
    const val LONGITUE_ALERT_KEY = "LONGITUE_ALERT_KEY"
    const val ALERT_ADDRESS_KEY = "ALERT_ADDRESS_KEY"
}