    ...
    private fun setUpDatePicker() {
        ...
        val datePickerDialog = DatePickerDialog(requireContext(),
                DatePickerDialog.OnDateSetListener { _, year, month, day ->
                    ...
                    if (toDayCalendar.get(Calendar.DAY_OF_YEAR) == calendar.get(Calendar.DAY_OF_YEAR) && toDayCalendar.get(Calendar.YEAR) == calendar.get(Calendar.YEAR)) {
                        mViewModel.mDateDisplayText.set(StringUtil.getString(R.string.today_txt))
                    } else {
                        mViewModel.mDateDisplayText.set(Utils.dateToString(calendar.time, Constant.DAY_OF_WEEK_FULL_FORMAT))
                    }
